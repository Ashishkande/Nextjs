...
export default function Navbar() {
    ...
    return (
        ...
        >
            ...
            <div className="lg:hidden">
                ...
                {isOpen && <div id='hamburger' className="flex flex-col min-w-[70vw] lg:hidden items-center justify-center fixed z-50 top-1/2 left-1/2 h-60 rounded-xl -translate-x-1/2 -translate-y-1/2 text-light dark:text-dark dark:bg-light/75 bg-dark/75 backdrop-blur-md py-32">
                    ...
                    <nav className='flex justify-between items-center '>
                        <MotionLink href={"https://github.com/Ashishkande"} target='_blank' className='mr-5 text-[26px]' variants={iconMotionVariants} animate="animate" whileHover="hover"><GithubIcon /></MotionLink>
                        <MotionLink href={"https://www.linkedin.com/in/ashish-kande-981439230/"} target='_blank' className='mr-5 text-[26px]' variants={iconMotionVariants} animate="animate" whileHover="hover"><LinkedInIcon /></MotionLink>
            ...
            <nav className='flex justify-between items-center'>
                <MotionLink href={"https://github.com/Ashishkande"} target='_blank' className='mr-5 text-[26px] hidden md:block' variants={iconMotionVariants} animate="animate" whileHover="hover"><GithubIcon /></MotionLink>
                <MotionLink href={"https://www.linkedin.com/in/ashish-kande-981439230/"} target='_blank' className='hidden md:block mr-5 text-[26px]' variants={iconMotionVariants} animate="animate" whileHover="hover"><LinkedInIcon /></MotionLink>
                <button onClick={() => { setMode(mode === "dark" ? "light" : "dark") }}>{mode === "dark" ? <SunIcon className={"fill-dark "} /> : <MoonIcon className={"fill-dark"} />}</button>
            </nav>
